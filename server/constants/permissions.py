# -*- coding: utf-8 -*-
"""
Permission point definitions and role-to-permission matrix.
...
class Permission:
    ...
    VIEW_SHADOW_AUDIT = "view:shadow_audit"
    VIEW_TEAM_INSIGHT = "view:team_insight"
    VIEW_SETTINGS = "view:settings"
    VIEW_SOP = "view:sop"
    VIEW_REALTIME = "view:realtime"
    VIEW_VIOLATIONS = "view:violations"

    ACTION_DISPATCH_TASK = "action:dispatch_task"
    ACTION_UPDATE_ROLE = "action:update_role"
    ACTION_COMPLETE_TASK = "action:complete_task"
    ACTION_LOG_ACTION = "action:log_action"
...
def get_role_meta(role: str) -> Dict[str, str]:
    ...
    """
    return ROLE_META.get(
        role,
        {"label": role, "color": "gray", "dashboard_view": "auditor"},
    )
